...
//        }
    ...
    fun getCommonCustomerDetail(customerEntity: CollectionEntry): CollectionEntry {
    ...
    fun getCommonCustomerDetailsText(fli: CollectionEntry?): String {
    ...
    fun setSalesSummaryDataForShare(customerEntities: List<CollectionEntry>): String {
